...
<template>
  ...
  <div
    ...
    v-if="type == 2"
    v-on:click="bubbleIsOpenTwo = !bubbleIsOpenTwo"
  >
    <p class="circle-title">{{ title }}</p>
  </div>
  <div
    ...
    v-if="type == 3"
    v-on:click="bubbleIsOpenThree = !bubbleIsOpenThree"
  >
    <p class="circle-title">{{ title }}</p>
  </div>
  <div
    ...
    v-if="type == 4"
    v-on:click="bubbleIsOpenFour = !bubbleIsOpenFour"
  >
    <p class="circle-title">{{ title }}</p>
  </div>
</template>
